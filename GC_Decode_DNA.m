function [uhat, Uhat] = GC_Decode_DNA(y,n,k,l,N,K,c,c1,c2,q,secondary,len_last,lim,P1,P2,t)
    ...
    for z=0:D
        ...
        for i=1:size(P1,1)
            ...
            for j=1:abs(d)
                m=mod(j-1,c1)+1;
                lengths(erasures(m))=lengths(erasures(m))+2*sign(d);
            end
